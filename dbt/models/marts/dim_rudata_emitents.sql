{{
  config(
    ...
    unique_key='id_emitent',
    merge_update_columns=['id_emitent', 'fininstid', 'shortname_rus', 'shortname_eng', 'inn', 'okpo', 'ogrn',
    ...
    'inn_fle', 'other_tin', 'other_tin_name', 'okfs_id', 'okfs_name', 'is_branch', 'counter']
  )
}}

SELECT
    CAST(id_emitent AS INTEGER) AS id_emitent,
    CAST(fininstid AS INTEGER) AS fininstid,
    shortname_rus,
    shortname_eng,
    inn,
    okpo,
